          ...
          <div className="space-y-6">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 md:p-8">
              ...
              <div className="flex gap-3">
                ...
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="w-10 h-10 md:w-12 md:h-12 bg-zinc-800 rounded-full flex items-center justify-center hover:bg-green-500 transition-colors" aria-label="WhatsApp SenCamCong">
                  <svg className="w-5 h-5 md:w-6 md:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
