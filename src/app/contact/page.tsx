    ...
    <div className="bg-black min-h-screen">
      ...
      <main className="px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto py-12 pb-24 md:pb-12">
        ...
        <div className="grid gap-4 sm:grid-cols-2 mb-8">
          <a href={`mailto:${contactEmail}`} className="group bg-zinc-900 border border-zinc-800 rounded-2xl p-6 md:p-8 flex flex-col items-center text-center hover:border-yellow-500 transition-all duration-300">
            <div className="w-14 h-14 bg-yellow-500/10 rounded-full flex items-center justify-center mb-4 group-hover:bg-yellow-500 transition-colors">
              <Mail className="w-6 h-6 text-yellow-500 group-hover:text-black transition-colors" />
            </div>
            <h2 className="text-lg font-bold text-white mb-1">Par email</h2>
            <p className="text-gray-400 text-sm break-all">{contactEmail}</p>
          </a>

          <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="group bg-zinc-900 border border-zinc-800 rounded-2xl p-6 md:p-8 flex flex-col items-center text-center hover:border-green-500 transition-all duration-300">
            <div className="w-14 h-14 bg-green-500/10 rounded-full flex items-center justify-center mb-4 group-hover:bg-green-500 transition-colors">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 md:p-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <a href="https://www.facebook.com/share/1C6aUmdeeZ/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 bg-zinc-800 rounded-xl py-5 hover:bg-blue-600 transition-colors" aria-label="Facebook SenCamCong">
            ...
            <a href="https://www.instagram.com/sencamcong?stkn=MTlydDJ3Y2R2cHVnbg%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 bg-zinc-800 rounded-xl py-5 hover:bg-pink-600 transition-colors" aria-label="Instagram SenCamCong">
              <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://youtube.com/@sencamcong?si=wNS1nx5CxQ5yv2-z" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 bg-zinc-800 rounded-xl py-5 hover:bg-red-600 transition-colors" aria-label="YouTube SenCamCong">
              <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.tiktok.com/@sencamcong.music?_r=1&_t=ZS-99XfpDdPXwy" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 bg-zinc-800 rounded-xl py-5 hover:bg-white transition-colors group" aria-label="TikTok SenCamCong">
              ...
              <span className="text-xs text-gray-300 group-hover:text-black transition-colors">TikTok</span>
            </a>
          </div>
        </div>
      </main>
